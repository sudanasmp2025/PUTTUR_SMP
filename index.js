...
function createBot() {
  ...
  bot.on('spawn', () => {
    ...
    setTimeout(() => {
      bot.chat(`/effect give ${baseUsername} minecraft:regeneration 10800 1`);
  ...
  // Detect when a player joins (from chat message)
  bot.on('messagestr', (message) => {
    // Example: [Puttur_SMP] .A1111318 Namaskara !
    const regex = /^\[Puttur_SMP\] (\S+) Namaskara !$/;
